...
@Native<
  Uint32 Function(Pointer<OrbisQueryStruct>, Uint32, Pointer<Uint32>, Uint32)
...
@Native<Pointer<Void> Function(Pointer<OrbisQueryStruct>, Uint32, Uint32)>(
  symbol: 'orbis_query_chunk_component_column',
  assetId: kOrbisCoreAsset,
)
...
@Native<OrbisTransformsStruct Function(Pointer<OrbisWorldStruct>)>(
  symbol: 'orbis_transform_register',
  assetId: kOrbisCoreAsset,
)
